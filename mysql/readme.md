...
```bash
docker-compose -f mysql/docker-compose.yml run db mysql -u nitesh -p --host=db
```
...
- `-u nitesh`: Specifies the MySQL user as `nitesh` This is the username that will be used when connecting to the MySQL server.
